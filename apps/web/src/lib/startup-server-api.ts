...
export function listMyCompanies() {
	return apiServer<MyCompany[]>("/api/v1/companies/myCompanies");
}

export function getEditableCompany(id: string) {
	return apiServer<Company>("/api/v1/companies/editorGet", { id });
}
