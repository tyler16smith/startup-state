		...
		<main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
			<div className="mb-8 max-w-3xl">
				...
				<p className="mt-3 text-muted-foreground">
					In about two minutes, Startup State Navigator will rank Utah resources
					against your stage, region, sector, and goals.
				</p>
			</div>
			<div className="rounded-lg border bg-white p-5 shadow-sm sm:p-8">
				<FounderIntakeForm />
			</div>
		</main>
	);
